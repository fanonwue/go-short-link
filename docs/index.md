...
entries without touching a server or writing code. The app regularly reads the sheet and updates itself automatically, 
...
set up the sheet, point the app at it, and enjoy instant, low‑maintenance link management with no external dependencies 
